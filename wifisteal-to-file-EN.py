...
wf = open("wifi.txt","r")
#network_list = re.findall(r"(?:Profile\s*:\s)(.*)",wf.read())
network_list = re.findall(r"(?:\s*:\s)(.*)",wf.read())
...
for network in network_list:
		...
		wifi_key = re.findall(r"(?:Key Content\s*:\s)(.*)",nf.read())
